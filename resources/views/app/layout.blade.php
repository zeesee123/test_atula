...
<html lang="en">
  <head>
    ...
    <!-- CSS files -->
    <link href="{{ config('app.env') === 'production' ? asset('admin/dist/css/tabler.min.css?1692870487') : asset('dist/css/tabler.min.css?1692870487') }}" rel="stylesheet"/>
    <link href="{{ config('app.env') === 'production' ? asset('admin/dist/css/tabler-flags.min.css?1692870487') : asset('dist/css/tabler-flags.min.css?1692870487') }}" rel="stylesheet"/>
    <link href="{{ config('app.env') === 'production' ? asset('admin/dist/css/tabler-payments.min.css?1692870487') : asset('dist/css/tabler-payments.min.css?1692870487') }}" rel="stylesheet"/>
    <link href="{{ config('app.env') === 'production' ? asset('admin/dist/css/tabler-vendors.min.css?1692870487') : asset('dist/css/tabler-vendors.min.css?1692870487') }}" rel="stylesheet"/>
    <link href="{{ config('app.env') === 'production' ? asset('admin/dist/css/demo.min.css?1692870487') : asset('dist/css/demo.min.css?1692870487') }}" rel="stylesheet"/>
		   ...
		   data-bs-placement="bottom">
            ...
            <div class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                <a href="#" class="dropdown-item">Statusabc</a>
