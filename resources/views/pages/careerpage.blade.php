...
<div class="page-header d-print-none">
  ...
  <div class="card-body">
    ...
    <form action="{{ url('/admin/careerpage') }}" enctype="multipart/form-data" method="POST" id="main_form">
        @csrf
            ...
            <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-2 pt-4">
                        <button type="button" class="btn btn-danger clear-btn" title="Reset Image">
                    ...
                    <div class="mb-3 col-4">
                        <img class="Thumbnail"
                             ...
                             width="400" alt="Banner Thumbnail">
                    </div>
                </div>
                ...
                <div class="mb-3 col-12">
                    ...
                    <textarea name="content" id="career_content" class="form-control" rows="10">{{ old('content', isset($model) ? $model->content : '') }}</textarea>
                    @error('content')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
