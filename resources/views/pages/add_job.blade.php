...
<div class="page-header d-print-none">
  ...
  <div class="card-body">
    ...
    <form action="{{ url('/admin/add_careers') }}" enctype="multipart/form-data" method="POST" id="main_form">
        @csrf
        ...
        <div class="card pt-3 p-4">
            <div class="row">
                ...
                <div class="mb-3 col-12">
                    ...
                    <textarea name="requirements" id="blog_content" class="form-control" rows="4">{{ old('requirements') }}</textarea>
                    @error('requirements')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
