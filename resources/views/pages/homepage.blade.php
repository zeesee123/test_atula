    ...
    <section>
        ...
        <div class="row">
            ...
            {{-- <div class="mb-3 col-6">
                <img class="videoThumbnail" src="{{ asset_env('images/default.jpg') }}" width="400" alt="Default Video Thumbnail">
                <video class="videoPreview" width="400" controls style="display:none;"></video>
            </div> --}}
            <div class="mb-3 col-4">
            
              <img class="videoThumbnail" 
       src="{{ asset_env('images/default.jpg') }}" 
       width="400" 
...
<section>
    ...
    <div class="row">
        <div class="row">
            ...
            <div class="col-4">
                <img class="Thumbnail" src="{{ $section->sec11_image?asset_env('homepage/'.$section->sec11_image):asset_env('images/default.jpg') }}" width="400" alt="Default Video Thumbnail">
            </div>
        </div>
