...
<div class="page-header d-print-none">
     ...
     <div class="container-xl">
      ...
      <div class="d-flex justify-content-between">
        <h3>Edit Blog</h3>
        <div><a class="btn btn-primary" href="https://www.akv.org.in/blogs/{{$blog->slug??''}}"><i class="bi bi-eye-fill mx-1"></i> Preview</a></div>
      </div>
  ...
  <div class="card-body">
    ...
    <form action="/admin/edit_blog/{{$blog->id}}" enctype="multipart/form-data" method="POST"  id="main_form">
    ...
    <div class="row">
        ...
        <div class="row">
            ...
            <div class="mb-3 col-4">
                <img class="Thumbnail" src="{{ $blog->blog_image ? asset_env('blogs/'.$blog->blog_image) : asset_env('images/default.jpg') }}" width="400" alt="Thumbnail">
            </div>
        </div>
        ...
        <div class="mb-3 col-6 mt-5">
            <div class="form-check form-switch">
                <input class="form-check-input" name="publish" type="checkbox" role="switch" id="switchCheckDefault" {{ $blog->publish ? 'checked' : '' }}>
        ...
        <div id="collapseSEO" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
            <div class="accordion-body">
                <div class="card pt-3 p-4">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Structured Data (Schema Markup)</label>
                        <textarea name="schema_markup" rows="5" class="form-control" placeholder="Paste JSON-LD here">{{ $blog->schema_markup }}</textarea>
                    </div>
...
<div class="text-end p-3" style="bottom:0;position:sticky;z-index:1030;">
    <button type="submit" class="btn btn-lg btn-primary p-3" id="spin_submit" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Save">
